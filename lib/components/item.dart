...
class _ItemState extends State<Item> {
  ...
  void loadImage() async {
    String imageUrl =
        'https://www.salonlfc.com/wp-content/uploads/2018/01/image-not-found-scaled-1150x647.png'; // Thay đổi đường dẫn URL thực tế
              ...
              Positioned(
                ...
                child: Column(
                  children: [
                    GestureDetector(
                      onTap: () {
                        CartPresenter.addItemToCart(widget.id, idCart, 1);
                        Navigator.push(
                          context,
                          MaterialPageRoute(
